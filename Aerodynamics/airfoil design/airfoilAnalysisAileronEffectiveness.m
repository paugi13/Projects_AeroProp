...
al0Simple = -2.2917;     % NASASC(2)0410 zero lift angle
...
fig1 = figure(1);
hold on
title("\textbf{Aileron effectiveness vs. Hinge position}");
...
print(fig1, 'plots/aileronEffectiveness', '-dpdf', '-r0', '-bestfit');
